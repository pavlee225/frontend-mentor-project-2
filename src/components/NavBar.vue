<template>
    <div class="flex justify-between items-center mt-5 mb-20 border-b-2 pb-5">
        <div class="flex space-x-11">
            <div><img src="@/assets/images/logo.svg" alt="logo" class="cursor-pointer"></div>
            <div>
                ...
                <div class="relative mx-auto w-auto max-w-2xl">
                    <div class="bg-white w-full rounded shadow-2xl flex flex-col p-5">
                        ...
                        <div class="flex flex-row gap-5 items-center mt-5">
                            ...
                            <div>
                                <p>{{ product.name }}</p>
                                <p>${{ product.price }} x {{ counter }} <span class="font-bold">${{ product.price * counter
                                }}</span></p>
                            </div>
                            <div>
